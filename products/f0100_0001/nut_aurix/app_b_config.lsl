...
#define LCF_INTVEC0_START 0x808FE000
#define LCF_INTVEC1_START 0x809FE000
#define LCF_INTVEC2_START 0x80AFE000
#define LCF_INTVEC3_START 0x80BFE000
#define LCF_INTVEC4_START 0x80F7E000
#define LCF_INTVEC5_START 0x80FFE000

#define LCF_TRAPVEC0_START 0x80700100
#define LCF_TRAPVEC1_START 0x80900000
#define LCF_TRAPVEC2_START 0x80A00000
#define LCF_TRAPVEC3_START 0x80B00000
#define LCF_TRAPVEC4_START 0x80F00000
#define LCF_TRAPVEC5_START 0x80F80000

#define LCF_STARTPTR_CPU0 0x80700000
#define LCF_STARTPTR_CPU1 0x80900100
#define LCF_STARTPTR_CPU2 0x80A00100
#define LCF_STARTPTR_CPU3 0x80B00100
#define LCF_STARTPTR_CPU4 0x80F00100
#define LCF_STARTPTR_CPU5 0x80F80100

#define LCF_STARTPTR_NC_CPU0 0xA0700000
#define LCF_STARTPTR_NC_CPU1 0xA0900100
#define LCF_STARTPTR_NC_CPU2 0xA0A00100
#define LCF_STARTPTR_NC_CPU3 0xA0B00100
#define LCF_STARTPTR_NC_CPU4 0xA0F00100
#define LCF_STARTPTR_NC_CPU5 0xA0F80100
...
derivative tc39
{
    ...
    memory pfls0
    {
        ...
        size = 2M;
        type = rom;
        map     cached (dest=bus:sri, dest_offset=0x80700000,           size=2M);
        map not_cached (dest=bus:sri, dest_offset=0xa0700000, reserved, size=2M);
    }
    ...
    memory pfls2
    {
        ...
        size = 1M;
        type = rom;
        map     cached (dest=bus:sri, dest_offset=0x80a00000,           size=1M);
        map not_cached (dest=bus:sri, dest_offset=0xa0a00000, reserved, size=1M);
    }
    ...
    memory pfls3
    {
        ...
        size = 1M;
        type = rom;
        map     cached (dest=bus:sri, dest_offset=0x80b00000,           size=1M);
        map not_cached (dest=bus:sri, dest_offset=0xa0b00000, reserved, size=1M);
    }
    ...
    memory pfls4
    {
        ...
        size = 512K;
        type = rom;
        map     cached (dest=bus:sri, dest_offset=0x80f00000,           size=512K);
        map not_cached (dest=bus:sri, dest_offset=0xa0f00000, reserved, size=512K);
    }
    ...
    memory pfls5
    {
        ...
        size = 512K;
        type = rom;
        map     cached (dest=bus:sri, dest_offset=0x80f80000,           size=512K);
        map not_cached (dest=bus:sri, dest_offset=0xa0f80000, reserved, size=512K);
    }
    ...
    memory lmuram0
    {
        ...
        size = 256K;
        type = ram;
        map     cached (dest=bus:sri, dest_offset=0x90040000,           size=256K);
    ...
    memory lmuram1
    {
        ...
        size = 256K;
        type = ram;
        map     cached (dest=bus:sri, dest_offset=0x90080000,           size=256K);
    ...
    memory lmuram2
    {
        ...
        size = 256K;
        type = ram;
        map     cached (dest=bus:sri, dest_offset=0x900C0000,           size=256K);
...
#        endif
        ...
        group a9 (ordered, align = 4, run_addr=mem:lmuram0)
        {
    ...
    section_layout :vtc:linear
    {
        ...
        group
        {
            ...
            group
            {
                ...
                group (ordered, attributes=rw, run_addr=mem:lmuram0)
                {
...
#        endif
    ...
    section_layout :vtc:linear
    {
        ...
        group
        {
            ...
            group flash_driver_code (ordered, attributes=rwx, copy, run_addr=mem:lmuram0/not_cached)
            {
                select "(.text.flash_driver_code*)";
            }
        }
    }
    ...
    section_layout :vtc:linear
    {
        ...
        {    
            ...
            /*Pony Platform Code Section*/
            group
            {
                /* section information for Platform auto initial. */
                group initial_sec (ordered, contiguous, align = 4, run_addr=mem:pfls0)
                {
                    select  ".initial_1";
                    select  ".initial_2";
                    select  ".initial_3";
                    ...
                    select  ".initial_15";
                    select  ".initial_16";
                    "__start_initial_sec" = "_lc_gb_initial_sec";
                    "__stop_initial_sec" = "_lc_ge_initial_sec";
                }
            }
        }
