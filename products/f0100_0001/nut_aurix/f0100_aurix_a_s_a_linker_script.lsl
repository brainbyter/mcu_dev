...
#define LCF_INTVEC1_START 0x803FE000
#define LCF_INTVEC2_START 0x804FE000
#define LCF_INTVEC3_START 0x805FE000
#define LCF_INTVEC4_START 0x80C7E000
#define LCF_INTVEC5_START 0x80CFE000

#define LCF_TRAPVEC0_START 0x80100100
#define LCF_TRAPVEC1_START 0x80300000
#define LCF_TRAPVEC2_START 0x80400000
#define LCF_TRAPVEC3_START 0x80500000
#define LCF_TRAPVEC4_START 0x80C00000
#define LCF_TRAPVEC5_START 0x80C80000

#define LCF_STARTPTR_CPU0 0x80100000
#define LCF_STARTPTR_CPU1 0x80300100
#define LCF_STARTPTR_CPU2 0x80400100
#define LCF_STARTPTR_CPU3 0x80500100
#define LCF_STARTPTR_CPU4 0x80C00100
#define LCF_STARTPTR_CPU5 0x80C80100

#define LCF_STARTPTR_NC_CPU0 0xA0100000
#define LCF_STARTPTR_NC_CPU1 0xA0300100
#define LCF_STARTPTR_NC_CPU2 0xA0400100
#define LCF_STARTPTR_NC_CPU3 0xA0500100
#define LCF_STARTPTR_NC_CPU4 0xA0C00100
#define LCF_STARTPTR_NC_CPU5 0xA0C80100
...
derivative tc39
{
    ...
    memory pfls0
    {
        ...
        size = 2M;
        type = rom;
        map     cached (dest=bus:sri, dest_offset=0x80100000,           size=2M);
        map not_cached (dest=bus:sri, dest_offset=0xa0100000, reserved, size=2M);
    }
    ...
    memory pfls2
    {
        ...
        size = 1M;
        type = rom;
        map     cached (dest=bus:sri, dest_offset=0x80400000,           size=1M);
        map not_cached (dest=bus:sri, dest_offset=0xa0400000, reserved, size=1M);
    }
    ...
    memory pfls3
    {
        ...
        size = 1M;
        type = rom;
        map     cached (dest=bus:sri, dest_offset=0x80500000,           size=1M);
        map not_cached (dest=bus:sri, dest_offset=0xa0500000, reserved, size=1M);
    }
    ...
    memory pfls4
    {
        ...
        size = 512K;
        type = rom;
        map     cached (dest=bus:sri, dest_offset=0x80c00000,           size=512K);
        map not_cached (dest=bus:sri, dest_offset=0xa0c00000, reserved, size=512K);
    }
    ...
    memory pfls5
    {
        ...
        size = 512K;
        type = rom;
        map     cached (dest=bus:sri, dest_offset=0x80c80000,           size=512K);
        map not_cached (dest=bus:sri, dest_offset=0xa0c80000, reserved, size=512K);
    }
