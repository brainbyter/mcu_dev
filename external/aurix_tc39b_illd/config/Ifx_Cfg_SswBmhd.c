...
#ifndef TC39B_BMI_VALUE
#pragma message " -------------------- NOTE from TC39B iLLD driver ------------------------ "
#pragma message "| Using default CRC INV 0xCE86AA8F for TC39B_BMI_VALUE of BMHD.  |"
#pragma message "| If you want to define it, you should add rule: tc39b_bmhd_generator.    |"
#pragma message " ------------------------------------------------------------------------- "
#define TC39B_BMI_VALUE 0xCE86AA8F
#endif

#ifndef TC39B_START_ADDRESS
#pragma message " -------------------- NOTE from TC39B iLLD driver ------------------------ "
#pragma message "| Using default value 0xA0000000 for TC39B_START_ADDRESS of BMHD. If you  |"
#pragma message "| want to define it, you should add rule: tc39b_bmhd_generator.           |"
#pragma message " ------------------------------------------------------------------------- "
#define TC39B_START_ADDRESS 0xA0000000
#endif

#ifndef TC39B_BMI_HEADER_CRC
#pragma message " -------------------- NOTE from TC39B iLLD driver ------------------------ "
#pragma message "| Using default CRC INV 0x31795570 for TC39B_BMI_HEADER_CRC of BMHD.      |"
#pragma message "| If you want to define it, you should add rule: tc39b_bmhd_generator.    |"
#pragma message " ------------------------------------------------------------------------- "
#define TC39B_BMI_HEADER_CRC 0x31795570
#endif

#ifndef TC39B_BMI_HEADER_CRC_INV
#pragma message " -------------------- NOTE from TC39B iLLD driver ------------------------ "
#pragma message "| Using default CRC INV 0xCE86AA8F for TC39B_BMI_HEADER_CRC_INV of BMHD.  |"
#pragma message "| If you want to define it, you should add rule: tc39b_bmhd_generator.    |"
#pragma message " ------------------------------------------------------------------------- "
#define TC39B_BMI_HEADER_CRC_INV 0xCE86AA8F
#endif

const Ifx_Ssw_Bmhd bmhd_0_orig =
{
    TC39B_BMI_VALUE,         /* 0x000: .bmi: Boot Mode Index (BMI)                                               */
    0xB359,         /* 0x002: .bmhdid: Boot Mode Header ID (CODE) = B359H                               */
    TC39B_START_ADDRESS,     /* 0x004: .stad: User Code start address                                            */
    TC39B_BMI_HEADER_CRC,     /* 0x008: .crc: Check Result for the BMI Header (offset 000H - 007H)                */
    TC39B_BMI_HEADER_CRC_INV,     /* 0x00C: .crcInv: Inverted Check Result for the BMI Header (offset 000H - 007H)    */
    {
